...
BOOST_AUTO_TEST_CASE(insertTest)
{
    ...
    auto callResult = cnsPrecompiled->call(tempExecutive, bytesConstRef(&in), "", "");
    ...
    callResult = cnsPrecompiled->call(tempExecutive, bytesConstRef(&in), "", "");
    ...
    callResult = (cnsPrecompiled->call(tempExecutive, bytesConstRef(&in2), "", ""));
