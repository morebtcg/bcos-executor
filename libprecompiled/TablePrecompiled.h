...
public:
    ...
    bcos::storage::TableInterface::Ptr getTable() { return m_table; }
    void setTable(bcos::storage::TableInterface::Ptr _table) { m_table = _table; }

    crypto::HashType hash();

private:
    bcos::storage::TableInterface::Ptr m_table;
};
}  // namespace precompiled
}  // namespace bcos
