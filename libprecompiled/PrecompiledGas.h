...
struct GasMetrics {
  ...
  void init() {
    OpCode2GasCost = {{InterfaceOpcode::EQ, VeryLow},
                      ...
                      {InterfaceOpcode::LE, VeryLow},
                      {InterfaceOpcode::LT, VeryLow},
                      {InterfaceOpcode::NE, VeryLow},
                      {InterfaceOpcode::Limit, VeryLow},
                      {InterfaceOpcode::GetInt, VeryLow},
                      {InterfaceOpcode::GetAddr, VeryLow},
                      {InterfaceOpcode::Set, VeryLow},
                      {InterfaceOpcode::GetByte32, 32 * VeryLow},
                      {InterfaceOpcode::GetByte64, 64 * VeryLow},
                      {InterfaceOpcode::GetString, VeryLow},
                      {InterfaceOpcode::CreateTable, CreateGas},
                      {InterfaceOpcode::OpenTable, LoadGas},
                      {InterfaceOpcode::Select, LoadGas},
                      {InterfaceOpcode::Insert, StoreGas},
                      {InterfaceOpcode::Update, StoreGas},
                      {InterfaceOpcode::Remove, RemoveGas},
                      {InterfaceOpcode::PaillierAdd, VerifyGas},
...
public:
  ...
  virtual void appendOperation(InterfaceOpcode const &_opType,
                               unsigned const &_opSize = 1);
