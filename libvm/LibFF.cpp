...
pair<bool, bytes> crypto::alt_bn128_pairing_product(bytesConstRef _in)
{
...
pair<bool, bytes> crypto::alt_bn128_G1_add(bytesConstRef _in)
{
    try
    {
        initLibFF();
...
pair<bool, bytes> crypto::alt_bn128_G1_mul(bytesConstRef _in)
{
    try
    {
        initLibFF();
